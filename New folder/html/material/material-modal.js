...
window.addEventListener("load", function () {
	...
	materialModalContent.style.borderRadius = "20px";
	...
	materialModalButtonOK.setAttribute(
		"onclick",
		"closeMaterialAlert(event, true);"
	);
	...
	materialModalButtonCANCEL.setAttribute(
		"onclick",
		"closeMaterialAlert(event, false);"
	);
	...
	materialConfirm("My Fav Song.", "Do you want to play my jam.", (res) => {
		if (res) {
